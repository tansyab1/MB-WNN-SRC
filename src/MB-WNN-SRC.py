...
# **MB-WNN-SRC-extend**: A novel multi-branch wavelet neural network for sparse representation based object classification (MB-WNN-SRC) is a transductive classification model based on sparse representations. 
